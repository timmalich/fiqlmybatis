...
public interface UsersMapper {
    ...
    @Results(value = {
            ...
            @Result(column = UserTable.COLUMN_FIRST_NAME, property = User.PROPERTY_FIRST_NAME, id = true),
            @Result(column = UserTable.COLUMN_LAST_NAME, property = User.PROPERTY_LAST_NAME, id = true),
            @Result(column = UserTable.COLUMN_EMAIL_ADDRESS, property = User.PROPERTY_EMAIL_ADDRESS, id = true)
    })
    List<User> findAll();
